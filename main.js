...
const defaultTodos = [
  { text: 'Love me like you do', done: true },
  { text: 'Love Ronelson Juit, char', done: false },
  { text: 'I will love you too, AHAHAGA', done: true },
  { text: 'Follow me on Facebook -Ronelson Juit', done: false },
  { text: 'Follow me on TikTok @itsmeblablu_ on IG', done: false },
  { text: 'Follow me on IG: @itsmeblablu_', done: false },
  { text: 'Eat na bebe huh? AHAHAHAHA', done: false }
];
